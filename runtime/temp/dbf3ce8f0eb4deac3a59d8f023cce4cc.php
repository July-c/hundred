<?php /*a:2:{s:53:"E:\WWW\free\application\user\view\app\help\index.html";i:1542013750;s:45:"E:\WWW\free\application\user\view\layout.html";i:1543209671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layer-u-sm-12 layer-u-md-12 layer-u-lg-12">
            <div class="widget layer-cf">
                <div class="widget-head layer-cf">
                    <div class="widget-title layer-cf">帮助中心</div>
                </div>
                            ...
                            <div class="layer-btn-toolbar">
                                <div class="layer-btn-group layer-btn-group-xs">
                                    <a class="layer-btn layer-btn-default layer-btn-success layer-radius"
                                       href="<?php echo url('app.help/add'); ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="layer-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?php echo url('app.help/edit',
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?php echo url('app.help/delete'); ?>";

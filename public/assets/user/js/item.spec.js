(function () {
    ...
    function itemSpec(options, baseData) {
        // 配置信息
    ...
    itemSpec.prototype = {
        ...
        submitAddSpecGroupEvent: function () {
            ...
            _this.$container.on('click', '.btn-addSpecName', function () {
                ...
                // 添加到数据库
                var load = layer.load();
                $.post(STORE_URL + '/item.spec/addSpec', {
        ...
        addSpecItemEvent: function () {
            ...
            _this.$container.on('click', '.btn-addSpecItem', function () {
                ...
                // 添加到数据库
                var load = layer.load();
                $.post(STORE_URL + '/Item.spec/addSpecValue', {

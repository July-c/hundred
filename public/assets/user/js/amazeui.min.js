...
function(t, e) {
	...
	return function(t) {
		...
		s.VERSION = "2.7.2", s.support = {}, s.support.transition = function() {
		...
		}, s.support.touch && r.addClass("layer-touch"), n(document).on("changed.dom.amui", function(t) {
			var e = t.target;
			...
			s.DOMReady = !0, n.each(s.DOMWatchers, function(t, e) {
				e(document)
			}), s.DOMObserve("[data-layer-observe]"), r.removeClass("no-js").addClass("js"), s.support.animation && r.addClass("cssanimations"), window.navigator.standalone && r.addClass("layer-standalone"), n(".layer-topbar-fixed-top").length && t.addClass("layer-with-topbar-fixed-top"), n(".layer-topbar-fixed-bottom").length && t.addClass("layer-with-topbar-fixed-bottom");
			var e = n(".layer-layout");
			e.find('[class*="md-block-grid"]').alterClass("md-block-grid-*"), e.find('[class*="lg-block-grid"]').alterClass("lg-block-grid"), n("[data-layer-widget]").each(function() {
				var t = n(this);
				0 === t.parents(".layer-layout").length && t.addClass("layer-no-layout")
			})
		}), t.exports = s
	}, function(t, e, i) {
		"use strict";
		...
		var n = i(1),
			...
			o = function(t, e) {
				var i = this;
				this.options = n.extend({}, o.DEFAULTS, e), this.$element = n(t), this.$element.addClass("layer-fade layer-in").on("click.alert.amui", ".layer-close", function() {
					i.close()
				})
			};
		o.DEFAULTS = {
			...
			var e = this.$element;
			e.trigger("close.alert.amui").removeClass("layer-in"), s.support.transition && e.hasClass("layer-fade") ? e.one(s.support.transition.end, t).emulateTransitionEnd(200) : t()
		}, s.plugin("alert", o), n(document).on("click.alert.amui.data-api", "[data-layer-alert]", function(t) {
			var e = n(t.target);
			e.is(".layer-close") && n(this).alert("close")
		}), t.exports = o
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
		...
		o.DEFAULTS = {
			loadingText: "loading...",
			disabledClassName: "layer-disabled",
			...
			var i = this.$element,
				...
				c = "layer-btn-" + t + " " + r.disabledClassName;
			t += "Text", r.resetText || (r.resetText = i[l]()), s.support.animation && r.spinner && "html" === l && !this.hasSpinner && (r.loadingText = '<span class="layer-icon-' + r.spinner + ' layer-icon-spin"></span>' + r.loadingText, this.hasSpinner = !0), e = e || (void 0 === a[t] ? r[t] : a[t]), i[l](e), setTimeout(n.proxy(function() {
				"loadingText" === t ? (i.addClass(c).attr(o, o), this.isLoading = !0) : this.isLoading && (i.removeClass(c).removeAttr(o), this.isLoading = !1)
			}, this), 0)
		}, o.prototype.toggle = function() {
			var t = !0,
				e = this.$element,
				i = this.$element.parent('[class*="layer-btn-group"]'),
			...
			dataOptions: "data-layer-loading",
			methodCall: function(t, e) {
				"toggle" === t[0] ? e.toggle() : "string" == typeof t[0] && e.setState.apply(e, t)
			}
		}), n(document).on("click.button.amui.data-api", "[data-layer-button]", function(t) {
			t.preventDefault();
			var e = n(t.target);
			e.hasClass("layer-btn") || (e = e.closest(".layer-btn")), e.button("toggle")
		}), s.ready(function(t) {
			n("[data-layer-loading]", t).button(), n("[data-layer-button]", t).find("input:checked").each(function() {
		...
		function n(t) {
			return this.each(function() {
				var e = s(this),
					...
					n = s.extend({}, a.DEFAULTS, o.utils.options(e.attr("data-layer-collapse")), "object" == typeof t && t);
		...
		a.DEFAULTS = {
			...
			if (!this.transitioning && !this.$element.hasClass("layer-in")) {
				var t = s.Event("open.collapse.amui");
				if (this.$element.trigger(t), !t.isDefaultPrevented()) {
					var e = this.$parent && this.$parent.find("> .layer-panel > .layer-in");
					if (e && e.length) {
						var i = e.data("amui.collapse");
						if (i && i.transitioning) return;
						n.call(e, "close"), i || e.data("amui.collapse", null)
					}
					this.$element.removeClass("layer-collapse").addClass("layer-collapsing").height(0), this.transitioning = 1;
					var a = function() {
							this.$element.removeClass("layer-collapsing").addClass("layer-collapse layer-in").height("").trigger("opened.collapse.amui"), this.transitioning = 0
						};
			...
			if (!this.transitioning && this.$element.hasClass("layer-in")) {
				...
				if (this.$element.trigger(t), !t.isDefaultPrevented()) {
					this.$element.height(this.$element.height()).redraw(), this.$element.addClass("layer-collapsing").removeClass("layer-collapse layer-in"), this.transitioning = 1;
					var e = function() {
							this.transitioning = 0, this.$element.trigger("closed.collapse.amui").removeClass("layer-collapsing").addClass("layer-collapse")
						};
			...
			this[this.$element.hasClass("layer-in") ? "close" : "open"]()
		}, s.fn.collapse = n, s(document).on("click.collapse.amui.data-api", "[data-layer-collapse]", function(t) {
			var e, i = s(this),
				a = o.utils.options(i.attr("data-layer-collapse")),
				...
				h = a.parent,
				d = h && s(h);
			c && c.transitioning || (d && d.find("[data-layer-collapse]").not(i).addClass("layer-collapsed"), i[l.hasClass("layer-in") ? "addClass" : "removeClass"]("layer-collapsed")), n.call(l, u)
		...
		var n = i(1),
			...
			a = function(t, e) {
				...
				}), this.isInput = this.$element.is("input"), this.component = !! this.$element.is(".layer-datepicker-date") && this.$element.find(".layer-datepicker-add-on"), this.isInput ? this.$element.on({
		...
		a.DEFAULTS = {
			...
			o.on("mousedown.datapicker.amui touchstart.datepicker.amui", function(t) {
				0 === n(t.target).closest(".layer-datepicker").length && e.close()
			...
			var t = this.component ? this.component.offset() : this.$element.offset(),
				...
				s = o.width() - t.left - e,
				a = this.isOutView();
			if (this.$picker.removeClass("layer-datepicker-right"), this.$picker.removeClass("layer-datepicker-up"), o.width() > 640) {
				if (a.outRight) return this.$picker.addClass("layer-datepicker-right"), void this.$picker.css({
					top: i,
					left: "auto",
					right: s
				});
				a.outBottom && (this.$picker.addClass("layer-datepicker-up"), i = t.top - this.$picker.outerHeight(!0))
			} else n = 0;
			this.$picker.css({
				top: i,
				left: n
			...
			for (var t = this.weekStart, e = "<tr>"; t < this.weekStart + 7;) e += '<th class="layer-datepicker-dow">' + a.locales[this.language].daysMin[t++ % 7] + "</th>";
			e += "</tr>", this.$picker.find(".layer-datepicker-days thead").append(e)
		}, a.prototype.fillMonths = function() {
			for (var t = "", e = 0; e < 12;) t += '<span class="layer-datepicker-month">' + a.locales[this.language].monthsShort[e++] + "</span>";
			this.$picker.find(".layer-datepicker-months td").append(t)
			...
			var t = new Date(this.viewDate),
				...
				l = this.$picker.find(".layer-datepicker-days .layer-datepicker-select");
			...
			for (var u, h, d, p = []; s.valueOf() < c;) s.getDay() === this.weekStart && p.push("<tr>"), u = this.onRender(s, 0), h = s.getFullYear(), d = s.getMonth(), d < i && h === e || h < e ? u += " layer-datepicker-old" : (d > i && h === e || h > e) && (u += " layer-datepicker-new"), s.valueOf() === n && (u += " layer-active"), p.push('<td class="layer-datepicker-day ' + u + '">' + s.getDate() + "</td>"), s.getDay() === this.weekEnd && p.push("</tr>"), s.setDate(s.getDate() + 1);
			this.$picker.find(".layer-datepicker-days tbody").empty().append(p.join(""));
			var m = this.date.getFullYear(),
				f = this.$picker.find(".layer-datepicker-months").find(".layer-datepicker-select").text(e);
			f = f.end().find("span").removeClass("layer-active").removeClass("layer-disabled");
			for (var v = 0; v < 12;) this.onRender(t.setFullYear(e, v), 1) && f.eq(v).addClass("layer-disabled"), v++;
			m === e && f.eq(this.date.getMonth()).removeClass("layer-disabled").addClass("layer-active"), p = "", e = 10 * parseInt(e / 10, 10);
			var g, y = this.$picker.find(".layer-datepicker-years").find(".layer-datepicker-select").text(e + "-" + (e + 9)).end().find("td"),
				w = new Date(this.viewDate);
			e -= 1;
			for (var b = -1; b < 11; b++) g = this.onRender(w.setFullYear(e), 2), p += '<span class="' + g + (b === -1 || 10 === b ? " layer-datepicker-old" : "") + (m === e ? " layer-active" : "") + '">' + e + "</span>", e += 1;
			y.html(p)
		}, a.prototype.click = function(t) {
			t.stopPropagation(), t.preventDefault();
			var e, i, s = this.$picker.find(".layer-datepicker-days").find(".layer-active"),
				o = this.$picker.find(".layer-datepicker-months"),
				a = o.find(".layer-active").index(),
				l = n(t.target).closest("span, td, th");
			if (1 === l.length) switch (l[0].nodeName.toLowerCase()) {
			case "th":
				switch (l[0].className) {
				case "layer-datepicker-switch":
					this.showMode(1);
					break;
				case "layer-datepicker-prev":
				case "layer-datepicker-next":
					this.viewDate["set" + r.modes[this.viewMode].navFnc].call(this.viewDate, this.viewDate["get" + r.modes[this.viewMode].navFnc].call(this.viewDate) + r.modes[this.viewMode].navStep * ("layer-datepicker-prev" === l[0].className ? -1 : 1)), this.fill(), this.set()
				}
				break;
			case "span":
				if (l.is(".layer-disabled")) return;
				l.is(".layer-datepicker-month") ? (e = l.parent().find("span").index(l), l.is(".layer-active") ? this.viewDate.setMonth(e, s.text()) : this.viewDate.setMonth(e)) : (i = parseInt(l.text(), 10) || 0, l.is(".layer-active") ? this.viewDate.setFullYear(i, a, s.text()) : this.viewDate.setFullYear(i)), 0 !== this.viewMode && (this.date = new Date(this.viewDate), this.$element.trigger({
				...
				break;
			case "td":
				if (l.is(".layer-datepicker-day") && !l.is(".layer-disabled")) {
					var c = parseInt(l.text(), 10) || 1;
					e = this.viewDate.getMonth(), l.is(".layer-datepicker-old") ? e -= 1 : l.is(".layer-datepicker-new") && (e += 1), i = this.viewDate.getFullYear(), this.date = new Date(i, e, c, 0, 0, 0, 0), this.viewDate = new Date(i, e, Math.min(28, c), 0, 0, 0, 0), this.fill(), this.set(), this.$element.trigger({
						type: "changeDate.datepicker.amui",
						date: this.date,
						viewMode: r.modes[this.viewMode].clsName
			...
			t && (this.viewMode = Math.max(this.minViewMode, Math.min(2, this.viewMode + t))), this.$picker.find(">div").hide().filter(".layer-datepicker-" + r.modes[this.viewMode].clsName).show()
			...
			this.theme && this.$picker.addClass("layer-datepicker-" + this.theme)
		}, a.locales = {
			en_US: {
		...
		var r = {
			...
			headTemplate: '<thead><tr class="layer-datepicker-header"><th class="layer-datepicker-prev"><i class="layer-datepicker-prev-icon"></i></th><th colspan="5" class="layer-datepicker-switch"><div class="layer-datepicker-select"></div></th><th class="layer-datepicker-next"><i class="layer-datepicker-next-icon"></i></th></tr></thead>',
			contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>'
		};
		r.template = '<div class="layer-datepicker layer-datepicker-dropdown"><div class="layer-datepicker-caret"></div><div class="layer-datepicker-days"><table class="layer-datepicker-table">' + r.headTemplate + '<tbody></tbody></table></div><div class="layer-datepicker-months"><table class="layer-datepicker-table">' + r.headTemplate + r.contTemplate + '</table></div><div class="layer-datepicker-years"><table class="layer-datepicker-table">' + r.headTemplate + r.contTemplate + "</table></div></div>", s.plugin("datepicker", a), s.ready(function(t) {
			n("[data-layer-datepicker]").datepicker()
		...
		var n = i(1),
			...
			r = function() {
				this.id = s.utils.generateGUID("layer-dimmer"), this.$element = n(r.DEFAULTS.tpl, {
					id: this.id
				}), this.inited = !1, this.scrollbarWidth = 0, this.$used = n([])
			};
		r.DEFAULTS = {
			tpl: '<div class="layer-dimmer" data-layer-dimmer></div>'
			...
			var s = this.$element;
			return s.removeClass("layer-active").trigger("close.dimmer.amui"), i.call(this), this
		}, r.prototype.checkScrollbar = function() {
			return this.scrollbarWidth = s.utils.measureScrollbar(), this
		}, r.prototype.setScrollbar = function() {
			var t = n(document.body),
				e = parseInt(t.css("padding-right") || 0, 10);
			return this.scrollbarWidth && t.css("padding-right", e + this.scrollbarWidth), t.addClass("layer-dimmer-active"), this
		}, r.prototype.resetScrollbar = function() {
			return n(document.body).css("padding-right", "").removeClass("layer-dimmer-active"), this
		...
		var n = i(1),
			...
			a = function(t, e) {
				this.options = n.extend({}, a.DEFAULTS, e), e = this.options, this.$element = n(t), this.$toggle = this.$element.find(e.selector.toggle), this.$dropdown = this.$element.find(e.selector.dropdown), this.$boundary = e.boundary === window ? n(window) : this.$element.closest(e.boundary), this.$justify = e.justify && n(e.justify).length && n(e.justify) || void 0, !this.$boundary.length && (this.$boundary = n(window)), this.active = !! this.$element.hasClass("layer-active"), this.animating = null, this.events()
			};
		a.DEFAULTS = {
			animation: "layer-animation-slide-top-fixed",
			boundary: window,
			justify: void 0,
			selector: {
				dropdown: ".layer-dropdown-content",
				toggle: ".layer-dropdown-toggle"
			},
			trigger: "click"
		}, a.prototype.toggle = function() {
			...
			var e = this.$toggle,
				i = this.$element,
				s = this.$dropdown;
			if (!e.is(".layer-disabled, :disabled") && !this.active) {
				i.trigger("open.dropdown.amui").addClass("layer-active"), e.trigger("focus"), this.checkDimensions(t);
			...
			if (this.active) {
				var t = "layer-dropdown-animation",
					e = this.$element,
					i = this.$dropdown;
				e.trigger("close.dropdown.amui");
				var s = n.proxy(function() {
					e.removeClass("layer-active").trigger("closed.dropdown.amui"), this.active = !1, this.animating = 0, this.$toggle.blur()
				}, this);
			...
			if (this.$dropdown.length) {
				...
				}), s + (i.left - a) > o && this.$element.addClass("layer-dropdown-flip")
			}
		}, a.prototype.clear = function() {
			n("[data-layer-dropdown]").not(this.$element).each(function() {
			...
			n("[data-layer-dropdown]", t).dropdown()
		}), n(document).on("click.dropdown.amui.data-api", ".layer-dropdown form", function(t) {
			t.stopPropagation()
		...
		(function(e) {
			...
			n.flexslider = function(t, i) {
				...
				if (void 0 === t && (t = {}), "object" == typeof t) return this.each(function() {
					var e = n(this),
						i = t.selector ? t.selector : ".layer-slides > li",
						s = e.find(i);
				...
				n("[data-layer-flexslider]", t).each(function(t, e) {
					var i = n(e),
		...
		var s = i(1),
			...
			c = function(t, e) {
				this.options = s.extend({}, c.DEFAULTS, e || {}), this.$element = s(t), this.$dialog = this.$element.find(".layer-modal-dialog"), this.$element.attr("id") || this.$element.attr("id", o.utils.generateGUID("layer-modal")), this.isPopup = this.$element.hasClass("layer-popup"), this.isActions = this.$element.hasClass("layer-modal-actions"), this.isPrompt = this.$element.hasClass("layer-modal-prompt"), this.isLoading = this.$element.hasClass("layer-modal-loading"), this.active = this.transitioning = this.relatedTarget = null, this.dimmer = this.options.dimmer ? a : {
					open: function() {},
					close: function() {}
				}, this.events()
			};
		c.DEFAULTS = {
			...
			var t = this,
				...
				o = i.find(".layer-modal-prompt-input"),
				a = i.find("[data-layer-modal-confirm]"),
				r = i.find("[data-layer-modal-cancel]"),
				l = function() {
					var t = [];
			...
			this.options.cancelable && i.on("keyup.modal.amui", function(e) {
				...
				t.close()
			}), i.on("click.close.modal.amui", "[data-layer-modal-close], .layer-modal-btn", function(i) {
				i.preventDefault();
				var n = s(this);
		...
		}, s.fn.modal = n, r.on("click.modal.amui.data-api", "[data-layer-modal]", function() {
			var t = s(this),
				e = o.utils.parseOptions(t.attr("data-layer-modal")),
		...
		c.DEFAULTS = {
			...
			var e = this,
				i = this.$element;
			if (i.length && !i.hasClass("layer-active")) {
				var n = this.options.effect,
					o = s("html"),
					l = s("body"),
					c = i.find(".layer-offcanvas-bar").first(),
					u = c.hasClass("layer-offcanvas-bar-flip") ? -1 : 1;
				c.addClass("layer-offcanvas-bar-" + n), a = {
					x: window.scrollX,
					y: window.scrollY
				}, i.addClass("layer-active"), l.css({
					width: window.innerWidth,
					height: r.height()
				}).addClass("layer-offcanvas-page"), "overlay" !== n && l.css({
					"margin-left": c.outerWidth() * u
				}).width(), o.css("margin-top", a.y * -1), setTimeout(function() {
					c.addClass("layer-offcanvas-bar-active").width()
				}, 0), i.trigger("open.offcanvas.amui"), this.active = 1, i.on("click.offcanvas.amui", function(t) {
					var i = s(t.target);
					i.hasClass("layer-offcanvas-bar") || i.parents(".layer-offcanvas-bar").first().length || (t.stopImmediatePropagation(), e.close())
			...
			function e() {
				r.removeClass("layer-offcanvas-page").css({
					width: "",
					height: "",
					"margin-left": "",
					"margin-right": ""
				}), l.removeClass("layer-active"), c.removeClass("layer-offcanvas-bar-active"), n.css("margin-top", ""), window.scrollTo(a.x, a.y), l.trigger("closed.offcanvas.amui"), i.active = 0
			}
			var i = this,
				n = s("html"),
				r = s("body"),
				l = this.$element,
				c = l.find(".layer-offcanvas-bar").first();
			l.length && this.active && l.hasClass("layer-active") && (l.trigger("close.offcanvas.amui"), o.support.transition ? (setTimeout(function() {
				c.removeClass("layer-offcanvas-bar-active")
			...
			var t = this;
			return l.on("click.offcanvas.amui", '[data-layer-dismiss="offcanvas"]', function(e) {
		...
		}, s.fn.offCanvas = n, l.on("click.offcanvas.amui", "[data-layer-offcanvas]", function(t) {
			t.preventDefault();
			var e = s(this),
		...
		a.DEFAULTS = {
			...
			open: !1,
			target: null,
			tpl: '<div class="layer-popover"><div class="layer-popover-inner"></div><div class="layer-popover-caret"></div></div>'
			...
			if (e && e.length) {
				...
				e.css({
					left: "",
					top: ""
				}).removeClass("layer-popover-left layer-popover-right layer-popover-top layer-popover-bottom"), r - g < h.top + g ? m = u.top - r - g : r < d - h.top - h.height ? (y = "bottom", m = u.top + c + a + g) : (y = "middle", m = c / 2 + u.top - n / 2), "top" === y || "bottom" === y ? (f = l / 2 + u.left - i / 2, v = f, f < 5 && (f = 5), f + i > p && (f = p - i - 20), "top" === y && e.addClass("layer-popover-top"), "bottom" === y && e.addClass("layer-popover-bottom"), v -= f) : "middle" === y && (f = u.left - i - a, e.addClass("layer-popover-left"), f < 5 && (f = u.left + l + a, e.removeClass("layer-popover-left").addClass("layer-popover-right")), f + i > p && (f = p - i - 5, e.removeClass("layer-popover-left").addClass("layer-popover-right"))), e.css({
					top: m + "px",
					left: f + "px"
				})
			}
			...
			var t = this.$popover;
			this.$element.trigger("open.popover.amui"), this.sizePopover(), t.show().addClass("layer-active"), this.active = !0
		}, a.prototype.close = function() {
			var t = this.$popover;
			this.$element.trigger("close.popover.amui"), t.removeClass("layer-active").trigger("closed.popover.amui").hide(), this.active = !1
		}, a.prototype.getPopover = function() {
			var t = s.utils.generateGUID("layer-popover"),
				e = [];
			return this.options.theme && n.each(this.options.theme.split(" "), function(t, i) {
				e.push("layer-popover-" + n.trim(i))
			}), n(this.options.tpl).attr("id", t).addClass(e.join(" "))
		}, a.prototype.setContent = function(t) {
			t = t || this.options.content, this.$popover && this.$popover.find(".layer-popover-inner").empty().html(t)
			...
			n("[data-layer-popover]", t).popover()
		}), t.exports = a
	}, function(t, e, i) {
		"use strict";
		var n = i(2),
		...
		var n = i(1),
			...
			c = function(t, e) {
				this.$element = n(t), this.$body = n(document.body), this.options = n.extend({}, c.DEFAULTS, e), this.$pureview = n(this.options.tpl).attr("id", s.utils.generateGUID("layer-pureview")), this.$slides = null, this.transitioning = null, this.scrollbarWidth = 0, this.init()
			};
		c.DEFAULTS = {
			tpl: '<div class="layer-pureview layer-pureview-bar-active"><ul class="layer-pureview-slider"></ul><ul class="layer-pureview-direction"><li class="layer-pureview-prev"><a href=""></a></li><li class="layer-pureview-next"><a href=""></a></li></ul><ol class="layer-pureview-nav"></ol><div class="layer-pureview-bar layer-active"><span class="layer-pureview-title"></span><div class="layer-pureview-counter"><span class="layer-pureview-current"></span> / <span class="layer-pureview-total"></span></div></div><div class="layer-pureview-actions layer-active"><a href="javascript: void(0)" class="layer-icon-chevron-left" data-layer-close="pureview"></a></div></div>',
			className: {
				prevSlide: "layer-pureview-slide-prev",
				nextSlide: "layer-pureview-slide-next",
				onlyOne: "layer-pureview-only",
				active: "layer-active",
				barActive: "layer-pureview-bar-active",
				activeBody: "layer-pureview-active"
			},
			selector: {
				slider: ".layer-pureview-slider",
				close: '[data-layer-close="pureview"]',
				total: ".layer-pureview-total",
				current: ".layer-pureview-current",
				title: ".layer-pureview-title",
				actions: ".layer-pureview-actions",
				bar: ".layer-pureview-bar",
				pinchZoom: ".layer-pinch-zoom",
				nav: ".layer-pureview-nav"
			},
			shareBtn: !1,
			toggleToolbar: !0,
			target: "img",
			...
			var t = this,
				...
				i = this.$element,
				s = this.$pureview;
			this.refreshSlides(), n("body").append(s), this.$title = s.find(e.selector.title), this.$current = s.find(e.selector.current), this.$bar = s.find(e.selector.bar), this.$actions = s.find(e.selector.actions), e.shareBtn && this.$actions.append('<a href="javascript: void(0)" class="layer-icon-share-square-o" data-layer-toggle="share"></a>'), this.$element.on("click.pureview.amui", e.target, function(i) {
				i.preventDefault();
			...
			}), s.find(".layer-pureview-direction").on("click.direction.pureview.amui", "li", function(e) {
				e.preventDefault(), n(this).is(".layer-pureview-prev") ? t.prevSlide() : t.nextSlide()
			...
			if (!t.data(i)) {
				...
				t.html(s).wrapInner('<div class="layer-pinch-zoom"></div>').redraw();
			...
			i.find("." + r).is(t) || this.transitioning || (this.loadImage(t, function() {
				s.utils.imageLoader(t.find("img"), function(e) {
					t.find(".layer-pinch-zoom").addClass("layer-pureview-loaded"), n(e).addClass("layer-img-loaded")
				})
			...
			if (1 !== this.$slides.length) {
				var t = this.$slides,
					e = t.filter(".layer-active"),
					i = t.index(e),
					n = "layer-animation-right-spring";
			...
			n("[data-layer-pureview]", t).pureview()
		}), t.exports = c
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
		...
		o.DEFAULTS = {
			animation: "fade",
			className: {
				inView: "layer-scrollspy-inview",
				init: "layer-scrollspy-init"
			},
			repeat: !0,
			delay: 0,
			topOffset: 0,
			...
			var t = this.$element,
				...
				n = e.animation ? " layer-animation-" + e.animation : "";
			...
			n("[data-layer-scrollspy]", t).scrollspy()
		}), t.exports = o
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
		...
		o.DEFAULTS = {
			...
			n("[data-layer-scrollspynav]", t).scrollspynav()
		}), t.exports = o
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
		...
		}, n(document).on("click.smoothScroll.amui.data-api", "[data-layer-smooth-scroll]", function(t) {
			t.preventDefault();
		...
		o.DEFAULTS = {
			...
			maxChecked: null,
			placeholder: "\u70b9\u51fb\u9009\u62e9...",
			selectedClass: "layer-checked",
			disabledClass: "layer-disabled",
			searchBox: !1,
			tpl: '<div class="layer-selected layer-dropdown <%= dropUp ? \'layer-dropdown-up\': \'\' %>" id="<%= id %>" data-layer-dropdown>  <button type="button" class="layer-selected-btn layer-btn layer-dropdown-toggle">    <span class="layer-selected-status layer-fl"></span>    <i class="layer-selected-icon layer-icon-caret-<%= dropUp ? \'up\' : \'down\' %>"></i>  </button>  <div class="layer-selected-content layer-dropdown-content">    <h2 class="layer-selected-header"><span class="layer-icon-chevron-left">\u8fd4\u56de</span></h2>   <% if (searchBox) { %>   <div class="layer-selected-search">     <input autocomplete="off" class="layer-form-field layer-input-sm" />   </div>   <% } %>    <ul class="layer-selected-list">      <% for (var i = 0; i < options.length; i++) { %>       <% var option = options[i] %>       <% if (option.header) { %>  <li data-group="<%= option.group %>" class="layer-selected-list-header">       <%= option.text %></li>       <% } else { %>       <li class="<%= option.classNames%>"          data-index="<%= option.index %>"          data-group="<%= option.group || 0 %>"          data-value="<%= option.value %>" >         <span class="layer-selected-text"><%= option.text %></span>         <i class="layer-icon-check"></i></li>      <% } %>      <% } %>    </ul>    <div class="layer-selected-hint"></div>  </div></div>',
			listTpl: '<% for (var i = 0; i < options.length; i++) { %>       <% var option = options[i] %>       <% if (option.header) { %>  <li data-group="<%= option.group %>" class="layer-selected-list-header">       <%= option.text %></li>       <% } else { %>       <li class="<%= option.classNames %>"          data-index="<%= option.index %>"          data-group="<%= option.group || 0 %>"          data-value="<%= option.value %>" >         <span class="layer-selected-text"><%= option.text %></span>         <i class="layer-icon-check"></i></li>      <% } %>      <% } %>'
			...
			e.hide();
			var o = {
				id: s.utils.generateGUID("layer-selected"),
			...
			}), this.$list = this.$selector.find(".layer-selected-list"), this.$searchField = this.$selector.find(".layer-selected-search input"), this.$hint = this.$selector.find(".layer-selected-hint");
			var a = this.$selector.find(".layer-selected-btn"),
				r = [];
			i.btnSize && r.push("layer-btn-" + i.btnSize), i.btnStyle && r.push("layer-btn-" + i.btnStyle), a.addClass(r.join(" ")), this.$selector.dropdown({
				justify: a
			}), e[0].disabled && this.disable(), i.maxHeight && this.$selector.find(".layer-selected-list").css({
			...
			this.maxChecked = u || 1 / 0, e[0].required && l.push("\u5fc5\u9009"), (c || u) && (c && l.push("\u81f3\u5c11\u9009\u62e9 " + c + " \u9879"), u && l.push("\u81f3\u591a\u9009\u62e9 " + u + " \u9879")), this.$hint.text(l.join("\uff0c")), this.renderOptions(), this.$element.after(this.$selector), this.dropdown = this.$selector.data("amui.dropdown"), this.$status = this.$selector.find(".layer-selected-status"), setTimeout(function() {
			...
			this.$originalOptions = this.$element.find("option"), this.multiple || null !== e.val() || this.$originalOptions.length && (this.$originalOptions.get(0).selected = !0), o.length ? o.each(function(e) {
				...
				options: n
			})), this.$shadowOptions = this.$list.find("> li").not(".layer-selected-list-header")
			...
			if (this.$shadowOptions.filter("." + i.selectedClass).each(function() {
				var i = n(this);
				s.push(i.find(".layer-selected-text").text()), t || (o = o.add(e.$originalOptions.filter('[value="' + i.data("value") + '"]').prop("selected", !0)))
			}), t) {
				var a = n(t);
			...
			var e;
			e = "number" == typeof t ? this.$list.find("> li").not(".layer-selected-list-header").eq(t) : "string" == typeof t ? this.$list.find(t) : n(t), e.trigger("click")
			...
			n("[data-layer-selected]", t).selected()
		}), t.exports = o
	}, function(t, e, i) {
		"use strict";
		i(15);
		...
		l.DEFAULTS = {
			...
			cancel: "\u53d6\u6d88",
			closeOnShare: !0,
			id: s.utils.generateGUID("layer-share"),
			desc: "Hi\uff0c\u5b64\u591c\u89c2\u5929\u8c61\uff0c\u53d1\u73b0\u4e00\u4e2a\u4e0d\u9519\u7684\u897f\u897f\uff0c\u5206\u4eab\u4e00\u4e0b\u4e0b ;-)",
			via: "Amaze UI",
			tpl: '<div class="layer-share layer-modal-actions" id="<%= id %>"><h3 class="layer-share-title"><%= title %></h3><ul class="layer-share-sns layer-avg-sm-3"><% for(var i = 0; i < sns.length; i++) {%><li><a href="<%= sns[i].shareUrl %>" data-layer-share-to="<%= sns[i].id %>" ><i class="layer-icon-<%= sns[i].icon %>"></i><span><%= sns[i].title %></span></a></li><% } %></ul><div class="layer-share-footer"><button class="layer-btn layer-btn-default layer-btn-block" data-layer-share-close><%= cancel %></button></div></div>'
		}, l.SNS = {
			weibo: {
				title: "\u65b0\u6d6a\u5fae\u535a",
			...
			if (!this.inited) {
				var t = this,
					e = "[data-layer-share-to]";
				r.ready(n.proxy(function() {
					n("body").append(this.render()), this.$element = n("#" + this.options.id), this.$element.find("[data-layer-share-close]").on("click.share.amui", function() {
						t.close()
					})
				}, this)), r.on("click.share.amui", e, n.proxy(function(t) {
					var i = n(t.target),
						s = i.is(e) && i || i.parent(e),
						o = s.attr("data-layer-share-to");
			...
			if (!this.$wechatQr) {
				var t = s.utils.generateGUID("layer-share-wechat"),
					e = n('<div class="layer-modal layer-modal-no-btn layer-share-wechat-qr"><div class="layer-modal-dialog"><div class="layer-modal-hd">\u5206\u4eab\u5230\u5fae\u4fe1 <a href="" class="layer-close layer-close-spin" data-layer-modal-close>&times;</a> </div><div class="layer-modal-bd"><div class="layer-share-wx-qr"></div><div class="layer-share-wechat-tip">\u6253\u5f00\u5fae\u4fe1\uff0c\u70b9\u51fb\u5e95\u90e8\u7684<em>\u53d1\u73b0</em>\uff0c<br/> \u4f7f\u7528<em>\u626b\u4e00\u626b</em>\u5c06\u7f51\u9875\u5206\u4eab\u81f3\u670b\u53cb\u5708</div></div></div></div>');
				e.attr("id", t);
				var i = new o({
					render: "canvas",
					correctLevel: 0,
				...
				e.find(".layer-share-wx-qr").html(i), e.appendTo(n("body")), this.$wechatQr = n("#" + t)
			}
			this.$wechatQr.modal("open")
		};
		var c = new l;
		r.on("click.share.amui.data-api", '[data-layer-toggle="share"]', function(t) {
		...
		o.DEFAULTS = {
			...
			className: {
				sticky: "layer-sticky",
				resetting: "layer-sticky-resetting",
				stickyBtm: "layer-sticky-bottom",
				animationRev: "layer-animation-reverse"
			}
		}, o.prototype.init = function() {
			var t = this.check();
			if (!t) return !1;
			...
			var s = n('<div class="layer-sticky-placeholder"></div>').css({
			...
			var i = this.options,
				n = this.$element,
				o = i.animation ? " layer-animation-" + i.animation : "",
				a = function() {
					n.css({
						position: "",
						top: "",
			...
			var e = this.options,
				...
				s = e.bottom,
				o = this.$element,
				a = e.animation ? " layer-animation-" + e.animation : "",
		...
		function n(t) {
			...
			return this.each(function() {
				var n = s(this),
					a = n.is(".layer-tabs") && n || n.closest(".layer-tabs"),
					r = a.data("amui.tabs"),
					l = s.extend({}, o.utils.parseOptions(n.data("amTabs")), s.isPlainObject(t) && t);
				r || a.data("amui.tabs", r = new c(a[0], l)), "string" == typeof t && ("open" === t && n.is(".layer-tabs-nav a") ? r.open(n) : e = "function" == typeof r[t] ? r[t].apply(r, i) : r[t])
			}), void 0 === e ? this : e
		}
		var s = i(1),
			o = i(2),
		...
		c.DEFAULTS = {
			selector: {
				nav: "> .layer-tabs-nav",
				content: "> .layer-tabs-bd",
				panel: "> .layer-tab-panel"
			},
			...
			var n = this.options.activeClass,
				o = e.find("> ." + n),
				a = i && r && !! o.length;
			o.removeClass(n + " layer-in"), t.addClass(n), a ? (t.redraw(), t.addClass("layer-in")) : t.removeClass("layer-fade");
			var l = s.proxy(function() {
				i && i(), this.transitioning = !1
			}, this);
			a && !this.$content.is(".layer-tabs-bd-ofv") ? o.one(r.end, l) : l()
		}, c.prototype.goTo = function(t) {
			var e = this.activeIndex,
				i = "next" === t,
				n = i ? "layer-animation-right-spring" : "layer-animation-left-spring";
			...
			s("[data-layer-tabs]", t).tabs()
		}), s(document).on("click.tabs.amui.data-api", "[data-layer-tabs] .layer-tabs-nav a", function(t) {
		...
		o.DEFAULTS = {
			checkboxClass: "layer-ucheck-checkbox",
			radioClass: "layer-ucheck-radio",
			checkboxTpl: '<span class="layer-ucheck-icons"><i class="layer-icon-unchecked"></i><i class="layer-icon-checked"></i></span>',
			radioTpl: '<span class="layer-ucheck-icons"><i class="layer-icon-unchecked"></i><i class="layer-icon-checked"></i></span>'
		}, o.prototype.init = function() {
			var t = this.$element,
				e = t[0],
				i = this.options;
			...
			this.$element.removeData("amui.ucheck").removeClass(this.options.checkboxClass + " " + this.options.radioClass).next(".layer-ucheck-icons").remove().end().trigger("destroyed.ucheck.amui")
		}, s.plugin("uCheck", o, {
			after: function() {
				s.support.touch && this.parent().hover(function() {
					n(this).addClass("layer-nohover")
				}, function() {
					n(this).removeClass("layer-nohover")
				})
			}
		}), s.ready(function(t) {
			n("[data-layer-ucheck]", t).uCheck()
		}), t.exports = o
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
		...
		o.DEFAULTS = {
			...
			activeClass: "layer-active",
			inValidClass: "layer-field-error",
			validClass: "layer-field-valid",
			validateOnSubmit: !0,
			alwaysRevalidate: !1,
			allFields: ":input:not(:submit, :button, :disabled, .layer-novalidate)",
			ignore: ":hidden:not([data-layer-selected], .layer-validate)",
			customEvents: "validate",
			keyboardFields: ":input:not(:submit, :button, :disabled, .layer-novalidate)",
			keyboardEvents: "focusout, change",
			activeKeyup: !1,
			textareaMaxlenthKeyup: !0,
			pointerFields: 'input[type="range"]:not(:disabled, .layer-novalidate), input[type="radio"]:not(:disabled, .layer-novalidate), input[type="checkbox"]:not(:disabled, .layer-novalidate), select:not(:disabled, .layer-novalidate), option:not(:disabled, .layer-novalidate)',
			pointerEvents: "click",
			onValid: function(t) {},
			...
			markValid: function(t) {
				var e = this.options,
					i = n(t.field),
					s = i.closest(".layer-form-group");
				i.addClass(e.validClass).removeClass(e.inValidClass), s.addClass("layer-form-success").removeClass("layer-form-error"), e.onValid.call(this, t)
			},
			markInValid: function(t) {
				var e = this.options,
					i = n(t.field),
					s = i.closest(".layer-form-group");
				i.addClass(e.inValidClass + " " + e.activeClass).removeClass(e.validClass), s.addClass("layer-form-error").removeClass("layer-form-success"), e.onInValid.call(this, t)
			},
			validate: function(t) {},
			submit: null
			...
			}), e(":input", a.customEvents), e(a.keyboardFields, a.keyboardEvents), e(a.pointerFields, a.pointerEvents), a.textareaMaxlenthKeyup && e("textarea[maxlength]", "keyup", 50), void(a.activeKeyup && e(".layer-active", "keyup", 50)))
			...
			if (!e.valid) {
				...
				return o.is("[data-layer-selected]") && (o = o.next(".layer-selected").find(".layer-selected-btn")), o.focus(), i("invalid"), !1
			}
			return i("valid"), !0
			...
			this.$element.find(".layer-form-success, .layer-form-error, ." + this.options.inValidClass + ", ." + this.options.validClass).removeClass(["layer-form-success", "layer-form-error", this.options.inValidClass, this.options.validClass].join(" "))
		}, o.prototype.destroy = function() {
			...
			n("[data-layer-validator]", t).validator()
		}), t.exports = o
	}, function(t, e, i) {
		"use strict";
		var n = i(2),
		...
		function n() {
			var t = s('[data-layer-widget="accordion"]'),
				e = {
					item: ".layer-accordion-item",
					title: ".layer-accordion-title",
					body: ".layer-accordion-bd",
					disabled: ".layer-disabled"
				};
			t.each(function(t, i) {
				var n = o.utils.parseOptions(s(i).attr("data-layer-accordion")),
					a = s(i).find(e.title);
				a.on("click.accordion.amui", function() {
					var t = s(this).next(e.body),
						o = s(this).parent(e.item),
						a = t.data("amui.collapse");
					o.is(e.disabled) || (o.toggleClass("layer-active"), a ? t.collapse("toggle") : t.collapse(), !n.multiple && s(i).children(".layer-active").not(o).not(e.disabled).removeClass("layer-active").find(e.body + ".layer-in").collapse("close"))
				})
			})
		}
		var s = i(1),
		...
		function n() {
			var t = s(".ds-thread"),
				e = t.parent('[data-layer-widget="duoshuo"]').attr("data-ds-short-name"),
		...
		function n() {
			s(".layer-figure").each(function(t, e) {
				var i, n = o.utils.parseOptions(s(e).attr("data-layer-figure")),
					a = s(e);
				if (n.pureview) if ("auto" === n.pureview) {
					var r = s.isImgZoomAble(a.find("img")[0]);
					r && a.pureview()
				} else a.addClass("layer-figure-zoomable").pureview();
		...
		i(20), s.isImgZoomAble = function(t) {
			...
			return i && s(t).closest(".layer-figure").addClass("layer-figure-zoomable"), i
		...
		function n() {
			s(".layer-footer-ysp").on("click", function() {
				s("#layer-footer-modal").modal()
			});
			var t = o.utils.parseOptions(s(".layer-footer").data("amFooter"));
		...
		function n() {
			var t = s('[data-layer-widget="gallery"]');
			t.each(function() {
				var t = o.utils.parseOptions(s(this).attr("data-layer-gallery"));
		...
		function n() {
			function t() {
				i[(n.scrollTop() > 50 ? "add" : "remove") + "Class"]("layer-active")
			}
			var e = s('[data-layer-widget="gotop"]'),
				i = e.filter(".layer-gotop-fixed"),
				n = s(window);
		...
		function n() {
			s('[data-layer-widget="header"]').each(function() {
				if (s(this).hasClass("layer-header-fixed")) return s("body").addClass("layer-with-fixed-header"), !1
			})
		}
		var s = i(1),
			o = i(2);
		...
		function s() {
			var t = document.querySelector(".layer-map"),
				e = 116.331398,
				i = 39.897445,
		...
		function n() {
			if (s("#mechat").length) {
				var t = s('[data-layer-widget="mechat"]'),
					e = t.data("layer-mechat-unitid"),
					i = s("<script>", {
						charset: "utf-8",
		...
		i(16), i(7);
		var a = function() {
				var t = n('[data-layer-widget="menu"]');
				t.find(".layer-menu-nav .layer-parent > a").on("click", function(t) {
					t.preventDefault();
					var e = n(this),
						i = e.parent(),
						s = e.next(".layer-menu-sub");
					i.toggleClass("layer-open"), s.collapse("toggle"), i.siblings(".layer-parent").removeClass("layer-open").children(".layer-menu-sub.layer-in").collapse("close")
				}), t.filter("[data-layer-menu-collapse]").find("> .layer-menu-toggle").on("click", function(t) {
					t.preventDefault();
					var e = n(this),
						i = e.next(".layer-menu-nav");
					e.toggleClass("layer-active"), i.collapse("toggle")
				}), t.filter("[data-layer-menu-offcanvas]").find("> .layer-menu-toggle").on("click", function(t) {
					t.preventDefault();
					var e = n(this),
						i = e.next(".layer-offcanvas");
					e.toggleClass("layer-active"), i.offCanvas("open")
				});
				var e = '.layer-offcanvas[data-dismiss-on="click"]',
					i = n(e);
				i.find("a").not(".layer-parent>a").on("click", function(t) {
					n(this).parents(e).offCanvas("close")
				}), t.filter(".layer-menu-one").each(function(t) {
					var e, i = n(this),
						s = n('<div class="layer-menu-nav-sub-wrap"></div>'),
						a = 0,
						r = i.find(".layer-menu-nav"),
						l = r.children("li");
					l.filter(".layer-parent").each(function(t) {
						n(this).attr("data-rel", "#layer-menu-sub-" + t), n(this).find(".layer-menu-sub").attr("id", "layer-menu-sub-" + t).appendTo(s)
					}), i.append(s), r.wrap('<div class="layer-menu-nav-wrap" id="layer-menu-' + t + '">'), l.each(function(t) {
						a += parseFloat(n(this).css("width"))
					}), r.width(a);
					var c = new o("#layer-menu-" + t, {
						eventPassthrough: !0,
						scrollX: !0,
						scrollY: !1,
						preventDefault: !1
					...
					l.on("click", function() {
						var t = n(this);
						t.addClass("layer-active").siblings().removeClass("layer-active"), s.find(".layer-menu-sub.layer-in").collapse("close"), t.is(".layer-parent") ? !t.hasClass(".layer-open") && s.find(t.attr("data-rel")).collapse("open") : t.siblings().removeClass("layer-open"), void 0 === e && (e = n(this).index() ? 0 : 1);
		...
		function n() {
			function t() {
				u.append(b), u.find("li").not(".layer-navbar-more").slice(i() - 1).appendTo(w), n.append(w)
			}
			function e() {
				return i() >= d ? (b.hide(), void w.find("li").insertBefore(b)) : (!n.find(".layer-navbar-actions").length && t(), b.show(), void(u.find("li").length < i() ? w.find("li").slice(0, i() - u.find("li").length).insertBefore(b) : u.find("li").length > i() && (w.find("li").length ? u.find("li").not(b).slice(i() - 1).insertBefore(w.find("li").first()) : u.find("li").not(b).slice(i() - 1).appendTo(w))))
			}
			function i() {
				return Math.floor((l.width() - f) / m)
			}
			var n = s('[data-layer-widget="navbar"]');
			if (n.length) {
				var l = s(window),
					c = s("body"),
					u = n.find(".layer-navbar-nav"),
					h = n.find("li"),
					d = h.length,
					p = u.attr("class") && parseInt(u.attr("class").match(/layer-avg-sm-(\d+)/)[1]) || 3,
					m = 60,
					f = 16,
					v = h.filter("[data-layer-navbar-share]"),
					g = h.filter("[data-layer-navbar-qrcode]"),
					y = "layer-active",
					w = s('<ul class="layer-navbar-actions"></ul>', {
						id: o.utils.generateGUID("layer-navbar-actions")
					}),
					b = s('<li class="layer-navbar-labels layer-navbar-more"><a href="javascript: void(0);"><span class="layer-icon-angle-up"></span><span class="layer-navbar-label">\u66f4\u591a</span></a></li>');
				if ("fixed" == n.css("position") && c.addClass("layer-with-fixed-navbar"), g.length) {
					var T = "layer-navbar-qrcode";
					if (C = s("#" + T), !C.length) {
						var x = g.attr("data-layer-navbar-qrcode"),
							C = s('<div class="layer-modal layer-modal-no-btn" id=""><div class="layer-modal-dialog"><div class="layer-modal-bd"></div></div></div>', {
								id: T
							}),
							E = C.find(".layer-modal-bd");
				...
				d > p && d > i() && t(), n.on("click.navbar.amui", ".layer-navbar-more", function(t) {
		...
		function n() {
			var t = s('[data-layer-widget="paragraph"]');
			t.each(function(t) {
				var e = s(this),
					i = o.utils.parseOptions(e.attr("data-layer-paragraph")),
					n = t;
		...
		i(20), s.fn.scrollTable = function(t) {
			var e, i = s(this);
			i.wrap('<div class="layer-paragraph-table-container" id="layer-paragraph-table-' + t + '"><div class="layer-paragraph-table-scroller"></div></div>'), e = i.parent(), e.width(i.width()), e.height(i.height()), new a("#layer-paragraph-table-" + t, {
				eventPassthrough: !0,
				scrollX: !0,
				scrollY: !1,
				preventDefault: !1
		...
		function n() {
			var t = s('[data-layer-widget="slider"]');
			t.not(".layer-slider-manual").each(function(t, e) {
				var i = o.utils.parseOptions(s(e).attr("data-layer-slider"));
				s(e).flexslider(i)
			})
		}
		var s = i(1),
		...
		function n() {
			s('[data-layer-widget="tabs"]').each(function() {
		...
		function n() {
			var t = s('[data-layer-widget="wechatpay"]');
			return a ? void t.on("click", ".layer-wechatpay-btn", function(t) {
				t.preventDefault();

        ...
        , defaultData = {
            ...
            video: {
                ...
                params: {
                    ...
                    poster: BASE_URL + 'assets/user/img/diy/video_poster.png'
                },
                style: {
                    paddingTop: '0',
                    height: '190'
            ...
            item: {
                ...
                defaultData: [
                    {
                        item_name: '此处显示商品名称',
                        image: BASE_URL + 'assets/user/img/diy/item/01.jpg',
                        item_price: '99.00'
                    },
                    {
                        item_name: '此处显示商品名称',
                        image: BASE_URL + 'assets/user/img/diy/item/02.jpg',
                        item_price: '99.00'
                    },
                    {
                        item_name: '此处显示商品名称',
                        image: BASE_URL + 'assets/user/img/diy/item/03.jpg',
                        item_price: '99.00'
                    },
                    {
                        item_name: '此处显示商品名称',
                        image: BASE_URL + 'assets/user/img/diy/item/04.jpg',
                        item_price: '99.00'
                    }
                ],
                // 手动选择: 默认数据
        ...
        , method = {
            ...
            editor: {
                ...
                addItem: {
                     ...
                     * @param $items
                     */
                    item: function (itemId, data, $items) {
                        var datas = method.diyData.addItemDatas(itemId, data);
                        $items.append(template('tpl_editor_data_item', datas));
                    }
                ...
                event: {
                    ...
                    switchBox: function () {
                        ...
                        $switch.find('input[data-switch]').change(function () {
                            ...
                            $switchItem.addClass('layer-hide')
                                .siblings('.' + selectClass)
                                .removeClass('layer-hide');
                        });
                    },
                            ...
                            getExistData: function () {
                                ...
                                for (var i in diyData.items[itemId].data) {
                                    if (diyData.items[itemId].data.hasOwnProperty(i)
                                        && typeof diyData.items[itemId].data[i]['item_id'] !== 'undefined')
                                        existdata.push(diyData.items[itemId].data[i]['item_id']);
                                }
                                return existdata;
                            }
                        });
